...
;(function($){
    $.fn.pgwSlider = function(options) {
        ...
        var getElement = function(obj) {
            ...
            var srcset = obj.find('img').attr('srcset');
        ...
        var updateHeight = function(height, animate) {
            ...
            pgwSlider.resizeEvent = setTimeout(function() {
                ...
                $('.slider-dots').css('top', (height - 40) + 'px');
        ...
        var setup = function() {
            ...
            pgwSlider.plugin.find('.ps-list > li').each(function() {
                ...
                if (element.image) {
                    currentElement.html('<img src="' + element.image + '" alt="' + (element.title ? element.title : '') + '" srcset="' + (element.srcset ? element.srcset : '') + '">');
                } else if (element.thumbnail) {
                    currentElement.html('<img src="' + element.thumbnail + '" alt="' + (element.title ? element.title : '') + '" srcset="' + (element.srcset ? element.srcset : '') + '">');
                }
